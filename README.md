...
- **Fase 2**: accounts (Auth.js magic link + Google), profielen (bezocht/ervaringen/wishlist), foto's (Vercel Blob), KVK-API-validatie, producentenportaal (`/portaal`, claim-flow), web-push. Het beheer-scherm (`/beheer`) is er al.
